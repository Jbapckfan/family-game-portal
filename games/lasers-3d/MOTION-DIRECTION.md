> September 8, 2026 amendment: the user approved the complete cinematic visual pass. [Current rules](CURRENT-RULES.md) and the [cinematic release notes](../../docs/reviews/2026-09-08-lasers-3d-cinematic.md) supersede this historical ledger for materials, charge/contact strength, chapter lighting and the finite victory sequence. Registry ownership, exact resting states, discovery, flat-view information boundaries and reduced-motion behavior remain binding. In particular, the new 1,200 ms winning-route pulse and surface wave are allowed; ambient or repeating ground waves remain disabled.
